...
class AppColors {
  ...
  // Call-to-action rose — all primary filled buttons and key interactive elements
  static const Color cta = Color(0xFFB5766D);
  static const Color ctaHover = Color(0xFF9B4E38);
